...
import { ArrowLeft, BookOpen, Download, FileText, Send, User, Tag, Calendar } from 'lucide-react'
import ProductCard from '@/components/products/ProductCard'
import { formatDate, getProductTypeLabel, generateWhatsAppLink } from '@/lib/utils'
...
export default async function DetailProdukPage({ params }) {
  ...
  const waMessage = `Halo, saya tertarik dengan ${getProductTypeLabel(product.type)} berjudul "${product.title}". Boleh saya mendapatkan informasi lebih lanjut?`
      ...
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              ...
              <div
                ...
                style={{ aspectRatio: '3/4', boxShadow: '0 8px 40px rgba(0,0,0,0.15)' }}
              >
          ...
          <div className="lg:col-span-2">
            ...
            >
              {/* Category */}
              <span className="badge-blue mb-4 inline-block">{product.category}</span>
